<?php
$update_account_info = "SELECT first_name, last_name, email, phone, address_1, address_2, city, hat_states_id, zip, date(date_created) as date_created
	FROM hat_customers WHERE hat_customers_id = $hat_customers_id";
