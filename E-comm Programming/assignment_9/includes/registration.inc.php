<form action='<? echo $_SERVER['PHP_SELF']; ?>' method='POST' name='registration_form' id='registration_form' enctype='multipart/form-data'>
	<fieldset><legend>Registration</legend>
		<?php
			...
			create_form_field('Style', 'text', 'shirt', 'shirt', ['maxlength'=>'50', 'size'=>'20', 'tabindex'=>'8', 'title'=>'City', 'pattern'=>'[A-Za-z]{2,50}', 'placeholder'=>'Style'], $errors_array);
			...
			if(!$exec_select_categories){
				...
				create_drop_down_from_query('Style: ', 'shirt_categories_id', 'shirt_categories_id', $multi_array, ['tabindex'=>'9', 'title'=>'State'], $errors_array);
			}
