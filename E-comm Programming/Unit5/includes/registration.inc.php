<form action='<? echo $_SERVER['PHP_SELF']; ?>' method='POST' name='registration_form' id='registration_form' enctype="multipart/form-data">
	...
	<p>
		<label for='phone'>Phone:</label><input type='tel' name='phone' id='phone' maxlength='50' size='30' value='' tabindex='4' title="Type in your web site address here"
	...
	<p>
		<label for='user_id'>User ID:</label><input type='user_id' name='user_id' id='user_id' maxlength='3' size='3' value='' max="999" min="0" step="2" tabindex='4' title="Type in your id here"
