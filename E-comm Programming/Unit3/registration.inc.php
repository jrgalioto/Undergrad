...
<body>
	<form action='/display_php_errors.php' method='POST' name='registration_form' id='registration_form' enctype='multipart/form-data'>
		<fieldset><legend>Bio</legend>
			<?php
				create_form_field('First Name:', 'text', 'first_name', 'first_name', '', ['maxlength'=>'20', 'size'=>'12', 'tabindex'=>'1', 'title'=>'Type in Your First Name Here', 'required'=>'required', 'placeholder'=>'First Name']);
				create_form_field('Last Name:', 'text', 'last_name', 'last_name', '', ['maxlength'=>'20', 'size'=>'12', 'tabindex'=>'2', 'title'=>'Type in Your Last Name Here', 'required'=>'required', 'placeholder'=>'Last Name']);
